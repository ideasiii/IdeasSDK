...
public class BluetoothPairUtils
{
	...
	{
		Method createBondMethod = btClass.getMethod("createBond", (Class[]) null);
		Boolean returnValue = (Boolean) createBondMethod.invoke(btDevice, (Object[]) null);
	...
	{
		Method removeBondMethod = btClass.getMethod("removeBond", (Class[]) null);
